...
describe('Delete', () => {
    ...
    it('account succesfully', async () => {
        ...
        await scrollDownAndTap('main.settings.other.button.logOut', 'main.settings.index.view');

        await scrollDownAndTap('main.settings.logout.logout', 'main.settings.logout.view');
        await scrollDownTo('onboarding.mentorlist.start', 'main.settings.logout.view');
    ...
    it('has cancel button', async () => {
        ...
        await scrollDownAndTap('main.settings.logout.cancel', 'main.settings.logout.view');
        await expect(element(by.id('main.settings.other.button.logOut'))).toBeVisible();
    });
});
