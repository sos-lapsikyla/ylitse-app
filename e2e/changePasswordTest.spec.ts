...
describe('changePassword', () => {
    ...
    it('for a mentee succesfully', async () => {
        ...
        await waitAndTypeText('main.settings.account.password.current', mentee.password + "\n");
        await waitAndTypeText('main.settings.account.password.new', newPassword + "\n");
        await waitAndTypeText('main.settings.account.password.repeat', newPassword + "\n");
